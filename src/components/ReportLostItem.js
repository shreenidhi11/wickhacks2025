...
import '../components/ReportLostItem.css'
        ...
        <div className="container">
            <form onSubmit={handleSubmit}>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="item_name" type="text" class="form-control" id="inputAddress" placeholder="Chemistry Book" onChange={handleChange} required />
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputState">Location lost</label>
                    ...
                    {/* <div class="form-group col-md-6">
                        <label for="inputCity">Location lost</label>
                        <input name="item_location" type="text" class="form-control" id="inputCity" placeholder="11, Memorial Drive" onChange={handleChange} required />
                    </div> */}

                    <div class="form-group col-md-6">
                        <label for="inputZip">Description</label>
                        <textarea name="description" type="text" class="form-control" id="inputZip" placeholder="I lost my chemistry book on 25th feb 2025. I think I lost it near Saunders College" onChange={handleChange} required />
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <label for="inputZip">Date lost</label>
                        <input name="date_lost" type="date" class="form-control" id="inputZip" onChange={handleChange} required />
                    </div>
                </div>
                <br></br>
